...
namespace Infoboard.Web.CastleWindsor
{
    public class ComponentRegistrar
    {
        ...
        private static void AddApplicationServicesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes.Pick()
                .FromAssemblyNamed("Infoboard.ApplicationServices")
                .WithService
                .FirstInterface());
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes.Pick()
                .FromAssemblyNamed("Infoboard.Data")
                .WithService
                .FirstNonGenericCoreInterface("Infoboard.Core"));
        }
